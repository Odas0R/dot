...
> Part of the [figma_use skill](../SKILL.md). How to correctly use the Plugin API for components, variants, and component properties.
>
...
If you must detach multiple nested instances across sibling components, do it in a **single** `figma_use` call — discover all targets by traversal at the start before any detachment mutates the tree.
