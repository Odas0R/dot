...
> Part of the [figma_use skill](../SKILL.md). How to create, apply, and inspect text styles using the Plugin API.
>
...
>
> For design system context (when to create text styles, how they relate to tokens, `figma_use` limitations), see [wwds-text-styles](working-with-design-systems/wwds-text-styles.md).
