...
- Shows each `wake` call in Pi's TUI with a preview of up to five loaded memory lines and its pagination or compression status; the agent still receives the full result.
